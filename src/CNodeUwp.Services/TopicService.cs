...
namespace CNodeUwp.Services
{
    ...
    {
        public async static Task<ObservableCollection<TopicResponse>> GetTopicListAsync(TopicPageRequest request, CancellationToken cancellationToken = default(CancellationToken))
        {
